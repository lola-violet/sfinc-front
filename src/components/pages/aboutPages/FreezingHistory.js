...
export default function FreezingHistory() {
    return (
        <div>
            ...
            <p>Nowadays, ground freezing is used worldwide for both civil and mining applications. Shafts from several feet to over 2,000 feet deep have been constructed using freezing as the only method of shoring and water cut-off. Foundation shoring, cofferdams, underpinning, and temporary access roads using ground freezing have become more and more common.</p>
            <p>In the 1990s, responding to industry needs, SoilFreeze took the lead in developing environmental applications and hazardous waste containment applications for soil freezing. Today, a large percentage of our projects have an environmental aspect that is effectively solved by our freeze system.</p>
        </div>
    )
}