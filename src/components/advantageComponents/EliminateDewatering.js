...
export default function EliminateDewatering() {
    return (
        <div id='eliminate-dewatering'>
            ...
            <p>Any probability that ground water may infiltrate from below the frozen soil perimeter wall is addressed by investigating the underlying soil’s permeability. The design engineer, using computer analysis, can estimate the probability of any seepage. To greatly reduce or eliminate any ground water seepage, the freeze pipes are installed deep enough to penetrate low permeable soils or they’re installed at angles to create a frozen “bottom.”</p>
        </div>
    )
}